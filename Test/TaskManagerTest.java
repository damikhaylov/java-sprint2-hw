...
abstract class TaskManagerTest<T extends TaskManager> {
    ...
    // TODO: Комментарий для ревью (удалить после спринта 6) - Тестирование изменения статуса и времён эпиков
    //  при выполнении методов TaskManager вынесено в отдельный класс EpicTest
